<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6">
                <a href="{{ route('projects.index') }}" class="text-indigo-600 hover:text-indigo-800 flex items-center group">
                        ...
                        <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                    ...
                                    <div>
                                        ...
                                        <select name="type" id="type" required
                                            class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                            <option value="preorder" {{ old('type') == 'preorder' ? 'selected' : '' }}>Pre-order Campaign</option>
                                            <option value="ready_stock" {{ old('type') == 'ready_stock' ? 'selected' : '' }}>Ready Stock</option>
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="4"
                                    class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('description') }}</textarea>
