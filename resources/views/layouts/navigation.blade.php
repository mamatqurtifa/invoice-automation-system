            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="group">
                        <x-application-logo class="block h-9 w-auto fill-current text-gray-800 transform transition-transform duration-300 ease-in-out group-hover:scale-110" />
                    </a>
                </div>
                    ...
                    <div x-data="{ open: false }" @click.away="open = false" @keydown.escape.window="open = false" class="relative">
                        ...
                        <div x-show="open" 
                            ...
                            <div class="p-2 space-y-1">
                                <a href="{{ route('projects.index') }}" class="block px-4 py-3 rounded-xl transition-all hover:bg-indigo-50">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500">{{ __('View and manage all your projects') }}</p>
                                        </div>
                                    </div>
                                </a>
                                <a href="{{ route('projects.create') }}" class="block px-4 py-3 rounded-xl transition-all hover:bg-indigo-50">
                                    <div class="flex items-center space-x-3">
                        ...
                        <div x-show="open" 
                            ...
                            <div class="p-4">
                                <div class="grid grid-cols-1 gap-4">
                                    <a href="#" class="group flex items-center gap-x-5 rounded-lg p-3 hover:bg-indigo-50">
                                        <div class="flex h-12 w-12 flex-none items-center justify-center rounded-lg bg-indigo-100 group-hover:bg-indigo-200 transition-colors duration-200">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-indigo-600" viewBox="0 0 20 20" fill="currentColor">
                                        ...
                                        <div>
                                            ...
                                            <p class="mt-1 text-xs text-gray-600">Create and manage custom order forms</p>
                                        </div>
                                    </a>
                                    <a href="#" class="group flex items-center gap-x-5 rounded-lg p-3 hover:bg-indigo-50">
                                        <div class="flex h-12 w-12 flex-none items-center justify-center rounded-lg bg-indigo-100 group-hover:bg-indigo-200 transition-colors duration-200">
                                        ...
                                        <div>
                                            ...
                                            <p class="mt-1 text-xs text-gray-600">Manage product catalog with variants</p>
                                        </div>
                                    </a>
                                    <a href="#" class="group flex items-center gap-x-5 rounded-lg p-3 hover:bg-indigo-50">
                                        <div class="flex h-12 w-12 flex-none items-center justify-center rounded-lg bg-indigo-100 group-hover:bg-indigo-200 transition-colors duration-200">
                                        ...
                                        <div>
                                            ...
                                            <p class="mt-1 text-xs text-gray-600">Generate invoices and track payments</p>
                                        </div>
                                    </a>
                                    <a href="#" class="group flex items-center gap-x-5 rounded-lg p-3 hover:bg-indigo-50">
                                        <div class="flex h-12 w-12 flex-none items-center justify-center rounded-lg bg-indigo-100 group-hover:bg-indigo-200 transition-colors duration-200">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-3">
                ...
                <div x-data="{ open: false }" @click.away="open = false" @keydown.escape.window="open = false" class="relative">
                    ...
                    <div x-show="open" 
                         ...
                         style="display: none;">
                        <div class="py-1">
                            <a href="{{ route('user-guide') }}" class="group flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-indigo-50">
                                <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 h-5 w-5 text-gray-400 group-hover:text-indigo-500" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M9 4.804A7.968 7.968 0 005.5 4c-1.255 0-2.443.29-3.5.804v10A7.969 7.969 0 015.5 14c1.669 0 3.218.51 4.5 1.385A7.962 7.962 0 0114.5 14c1.255 0 2.443.29 3.5.804v-10A7.968 7.968 0 0014.5 4c-1.255 0-2.443.29-3.5.804V12a1 1 0 11-2 0V4.804z" />
                                </svg>
                                User Guide
                            </a>
                            <a href="{{ route('faq') }}" class="group flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-indigo-50">
                                <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 h-5 w-5 text-gray-400 group-hover:text-indigo-500" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div x-data="{ open: false }" @click.away="open = false" @keydown.escape.window="open = false" class="relative">
                    <button @click="open = !open" 
                        ...
                        @if(auth()->user()->unreadNotificationsCount() > 0)
                            <span class="absolute top-1 right-1 transform translate-x-1/2 -translate-y-1/2 flex h-5 w-5">
                                <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                                <span class="relative rounded-full h-5 w-5 bg-red-500 text-white text-xs flex items-center justify-center">
                    ...
                    <div x-show="open" 
                        ...
                        <div class="py-2">
                            @forelse(auth()->user()->notifications()->whereNull('read_at')->latest()->take(5)->get() as $notification)
                                <a href="{{ route('notifications.markAsRead', $notification) }}" class="flex items-start px-4 py-3 hover:bg-indigo-50 {{ $loop->first ? '' : 'border-t border-gray-100' }}">
                ...
                <div x-data="{ open: false }" @click.away="open = false" @keydown.escape.window="open = false" class="relative">
                    <div>
                        <button @click="open = !open" class="flex items-center transition duration-150 ease-in-out group">
                            <div class="h-10 w-10 rounded-full overflow-hidden border-2 border-indigo-100 group-hover:border-indigo-200 transition-all duration-200 flex-shrink-0">
                                <img class="h-full w-full object-cover" src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&color=7F9CF5&background=EBF4FF" alt="{{ auth()->user()->name }}">
                            </div>
                            <div class="ml-2 hidden md:block">
                                <div class="text-sm font-medium text-gray-800 group-hover:text-indigo-600 transition-colors duration-200">{{ auth()->user()->name }}</div>
                                <div class="text-xs text-gray-500 group-hover:text-indigo-500 transition-colors duration-200">{{ auth()->user()->email }}</div>
                            </div>
                        </button>
                    </div>
                    ...
                    <div x-show="open" 
                        ...
                        <div class="py-1">
                            <a href="{{ route('profile.edit') }}" class="group flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-indigo-50">
                                <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 h-5 w-5 text-gray-400 group-hover:text-indigo-500" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" class="w-full text-left group flex items-center px-4 py-3 text-sm text-red-700 hover:bg-red-50">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 h-5 w-5 text-red-400 group-hover:text-red-500" viewBox="0 0 20 20" fill="currentColor">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div x-data="{ expanded: false }" class="border-l-4 border-transparent pl-3">
                <button @click="expanded = !expanded" class="flex items-center justify-between w-full py-2 px-3 text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out">
                    ...
                    <svg class="h-5 w-5 transform transition-transform duration-200" :class="{'rotate-90': expanded}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
